               ...
               <div class="row">
                  ...
                  <div class="col-xs-12 col-md-6">
                     <div class="form-group">
                        ...
                        <input type="number" class="form-control enable-disabled" id="inputCP" name="inputCP"
...
function agregarDireccion() {
   ...
   if (pais == '' || estado == '' || ciudad == '' || calle == '' || Cp == '') {
      alert("Debe ingresar los campos marcado con * (obligatorios)");
      $('#loading').hide();
   } else {
      var htmlTags = '<tr id="r' + rowCount + '">' +
         '<td hidden>' + 'nvaDireccion' + '</td>' +
         '<td>' + pais + '</td>' +
         '<td>' + estado + '</td>' +
         '<td>' + ciudad + '</td>' +
         '<td>' + Municipio + '</td>' +
...
function eliminarDireccion(row, idDireccion) {
   if (idDireccion != 0) {
      $.ajax({
         type: 'get',
         url: 'eliminarDireccion/{idDireccion}',
         data: {
            id: idDireccion
         },
         success: function(data) {
